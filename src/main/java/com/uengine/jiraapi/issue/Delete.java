...
public class Delete {
     ...
     */
    public Map<String, Object> invokeDelete(String auth, String url)  {
        ...
        if (statusCode == 204) {
            ...
            String temp = new String(Base64.decode(auth)).split(":")[0];
            map.put("isDeleted", false);
            map.put("errorCode", statusCode);
            map.put("errorMsg", temp + "은(는) 해당 이슈에 대한 삭제 권한이 없습니다.");
